public abstract class Pet {
    ...
    //Water adds 1 shield point to itself and another pet
    ...
    public String toString() {
        return String.format("%s:%n %-10s %-10s%n %-10s %-10s%n %-10s %-10s%n %-10s %-10s%n %-10s %-10s%n",getName(), "Tier:", level, "Attack:", attack, "Shield:", shield, "Health:", health, "Habitat:", habitat);
